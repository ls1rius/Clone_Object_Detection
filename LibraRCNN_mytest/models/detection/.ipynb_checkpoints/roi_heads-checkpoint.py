...
from ..mmdet_module import balanced_l1_loss
...
#     box_loss = box_loss / labels.numel()
    ...
    box_loss = balanced_l1_loss(box_regression[sampled_pos_inds_subset, labels_pos], 
                                regression_targets[sampled_pos_inds_subset])
...
class RoIHeads(nn.Module):
    ...
    def __init__(self,
        ...
        # L10 CHANGE
        self.fg_bg_sampler = det_utils.IOUBalancedPosNegSampler(
    ...
    def assign_targets_to_proposals(self, proposals, gt_boxes, gt_labels):
        ...
        for proposals_in_image, gt_boxes_in_image, gt_labels_in_image in zip(proposals, gt_boxes, gt_labels):
            ...
            match_quality_matrix_list.append(match_quality_matrix.data.detach().cpu())
        return matched_idxs, labels, match_quality_matrix_list

    def subsample(self, labels, match_quality_matrix_list):
        # type: (List[Tensor]) -> List[Tensor]
        sampled_pos_inds, sampled_neg_inds = self.fg_bg_sampler(labels, match_quality_matrix_list)
        sampled_inds = []
    ...
    def select_training_samples(self,
        ...
        # L10 CHANGE
        matched_idxs, labels, match_quality_matrix_list = self.assign_targets_to_proposals(proposals, gt_boxes, gt_labels)
        # sample a fixed proportion of positive-negative proposals
        sampled_inds = self.subsample(labels, match_quality_matrix_list)
