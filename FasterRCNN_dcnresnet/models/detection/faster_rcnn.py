...
from .backbone_utils import resnet_fpn_backbone, dcnresnet_fpn_backbone, _validate_trainable_layers, mobilenet_backbone

from CFG import CFG

__all__ = [
    "FasterRCNN", "fasterrcnn_resnet_fpn", "fasterrcnn_resnet50_fpn", "fasterrcnn_mobilenet_v3_large_320_fpn",
    "fasterrcnn_mobilenet_v3_large_fpn", "fasterrcnn_dcnresnet_fpn"
]
...
def fasterrcnn_dcnresnet_fpn(pretrained=False, progress=True, backbone_name='dcnresnet50',
    ...
    backbone = dcnresnet_fpn_backbone(backbone_name, pretrained_backbone, trainable_layers=trainable_backbone_layers)
