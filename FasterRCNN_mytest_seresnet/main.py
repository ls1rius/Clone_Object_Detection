...
from CFG import CFG
import argparse
from models.detection import fasterrcnn_resnet_fpn, fasterrcnn_seresnet_fpn
...
def train(local_rank):
    device = CFG.DEVICE
#     model = fasterrcnn_resnet_fpn(num_classes=len(CLONE_CLASSES), pretrained_backbone=True, trainable_backbone_layers=5, backbone_name='seresnet18')
    model = fasterrcnn_seresnet_fpn(num_classes=len(CLONE_CLASSES), pretrained_backbone=True, trainable_backbone_layers=5, backbone_name='seresnet18')
