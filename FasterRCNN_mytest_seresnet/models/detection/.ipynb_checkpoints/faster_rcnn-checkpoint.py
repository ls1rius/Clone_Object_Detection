...
from .backbone_utils import resnet_fpn_backbone, seresnet_fpn_backbone, _validate_trainable_layers, mobilenet_backbone

from CFG import CFG

__all__ = [
    "FasterRCNN", "fasterrcnn_resnet_fpn", "fasterrcnn_resnet50_fpn", "fasterrcnn_mobilenet_v3_large_320_fpn",
    "fasterrcnn_mobilenet_v3_large_fpn", "fasterrcnn_seresnet_fpn"
]
...
def fasterrcnn_seresnet_fpn(pretrained=False, progress=True, backbone_name='seresnet50',
    ...
    backbone = seresnet_fpn_backbone(backbone_name, pretrained_backbone, trainable_layers=trainable_backbone_layers)
