...
from ..mmdet_module import giou_loss
...
#         import pdb;pdb.set_trace()
        ...
        regression_targets = self.box_coder.decode(regression_targets, proposals).squeeze()


        box_loss = giou_loss(box_regression[sampled_pos_inds_subset, labels_pos],
                            regression_targets[sampled_pos_inds_subset]).mean()
