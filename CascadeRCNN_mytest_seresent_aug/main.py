...
from CFG import CFG
import argparse
from models.detection import cascade_rcnn_resnet_fpn, cascade_rcnn_seresnet_fpn
...
def train(local_rank):
    device = CFG.DEVICE
    model = cascade_rcnn_seresnet_fpn(num_classes=len(CLONE_CLASSES), pretrained_backbone=True, trainable_backbone_layers=5, backbone_name='seresnet18')
#     model = cascade_rcnn_resnet_fpn(num_classes=len(CLONE_CLASSES), pretrained_backbone=True, trainable_backbone_layers=5, backbone_name='resnet18')
